        ...
        pdfWindow.document.write(`
          ...
          <html lang="ko">
            <head>
              ...
              <meta name="viewport" content="width=device-width, initial-scale=1" />
              <style>
                html, body { width: 100%; height: 100%; margin: 0; background: #2b2b2b; font-family: -apple-system, BlinkMacSystemFont, "Apple SD Gothic Neo", "Noto Sans KR", sans-serif; }
                .toolbar { height: 48px; display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 0 14px; background: #162238; color: #fff; box-sizing: border-box; font-size: 13px; }
                .toolbar a { color: #fff; text-decoration: none; border: 1px solid rgba(255,255,255,0.45); border-radius: 999px; padding: 7px 12px; white-space: nowrap; }
                iframe { width: 100%; height: calc(100% - 48px); border: 0; background: #fff; }
              </style>
            </head>
            <body>
              <div class="toolbar"><span>${safeFileName}</span><a href="${safePdfUrl}" download="${safeFileName}">다운로드</a></div>
              <iframe src="${safePdfUrl}" title="제이크이미지연구소 견적서 PDF"></iframe>
            </body>
          </html>
        `);
        pdfWindow.document.close();
